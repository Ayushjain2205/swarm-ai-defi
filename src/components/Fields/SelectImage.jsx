...
const SelectImage = ({ placeholder, options, onOptionSelected }) => {
  ...
  const handleSelect = (option) => {
    ...
    setIsOpen(false);
    onOptionSelected(option); // Trigger the callback function passed as prop
  };
      ...
      >
        <div className="flex items-center gap-2">
          {selectedOption ? (
            ...
            <span className="text-black text-sm text-opacity-30">
              {placeholder}
            </span>
          )}
        </div>
